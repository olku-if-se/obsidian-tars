...
import { ConsoleLogger, type ILogger } from '../adapters'
import type { MCPServerConfig } from './index'

// Use console logger for config parsing (standalone utility)
const logger: ILogger = new ConsoleLogger('[MCP:config]')
