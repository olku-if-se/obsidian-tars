import { DocumentWriteLock, MCPIntegration, MCPToolInjector } from '@tars/contracts'
import { z } from 'zod'
...
export const mcpIntegrationSchema = z.custom<MCPIntegration>((value) => typeof value === 'object' && value !== null, 'MCP integration is required')
