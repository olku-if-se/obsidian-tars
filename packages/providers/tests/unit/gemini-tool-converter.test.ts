...
describe('Gemini Tool Converter', () => {
  ...
  describe('schema validation', () => {
    ...
    it('should reject invalid schemas', () => {
      ...
      expect(() => geminiConverter.validateGeminiSchema(invalidSchema))
        .toThrow('Schema must be of type object')
    })
    ...
    it('should validate parameter names', () => {
      ...
      expect(() => geminiConverter.validateGeminiSchema(schemaWithInvalidParam))
        .not.toThrow() // Implementation would handle name validation
    })
  })
  ...
  describe('error handling', () => {
    it('should handle malformed tool definitions', () => {
      ...
      expect(() => geminiConverter.convertMCPToolsToGemini([malformedTool]))
        .toThrow('Invalid tool definition: missing name or schema')
    })
    ...
    it('should handle circular references in schemas', () => {
      ...
      expect(() => geminiConverter.convertMCPToolsToGemini([toolWithCircularRef]))
        .toThrow('Circular reference detected in schema')
    })
  })
})