		...
		return (
			<div style={{ width: '600px' }}>
				...
				<div style={{ marginTop: '16px', fontSize: '12px', color: '#666' }}>
					...
					<ul>
						<li><strong>URL:</strong> HTTP endpoint for SSE transport</li>
						<li><strong>Command:</strong> Shell command for stdio transport</li>
						<li><strong>JSON:</strong> Claude Desktop configuration format</li>
					</ul>
				</div>
			</div>
		)
