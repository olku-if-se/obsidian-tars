...
const meta = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					'Atomic element for rendering semantic label-value pairs. Used for stats displays, forms, and key-value information.'
			}
		}
	},
	tags: ['autodocs'],
...
export const LongText: Story = {
	args: {
		label: 'Description:',
		value:
			'This is a very long value that demonstrates how the component handles lengthy content that might need to wrap or overflow'
	}
}
