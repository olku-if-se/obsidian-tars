...
- Maintains consistent spacing and typography
	...
	argTypes: {
		...
		layoutRatio: {
			description:
				'Controls the relative space between info (left) and control (right) columns as [info, control] flex grow values',
			control: 'object'
		}
	}
...
export const LongDescription: Story = {
	args: {
		...
		description:
			'Replace internal links in assistant messages with their referenced content. Note: This feature is generally not recommended as assistant-generated content may contain non-existent links that could lead to unexpected behavior.',
		children: (
			<Toggle
				checked={false}
				onChange={() => {
