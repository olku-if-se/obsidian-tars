...
const meta = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					'Atomic element for interactive tab navigation. The smallest interactive navigation unit for modal tabs and navigation interfaces.'
			}
		}
	},
	tags: ['autodocs'],
...
const InteractiveTabList = ({ initialTab = 'tab1', ...props }: InteractiveTabListProps) => {
	...
	return <TabList {...props} activeTab={activeTab} onTabChange={setActiveTab} />
}
				...
				content: (
					<div style={{ padding: '20px' }}>
						...
						<div style={{ display: 'grid', gap: '10px' }}>
							...
							<div>
								<strong>Characters:</strong> 1,234
							</div>
							<div>
				...
				content: (
					<div style={{ padding: '20px' }}>
						...
						<div style={{ backgroundColor: '#ffe6e6', padding: '10px', borderRadius: '4px' }}>
							<p>
								<strong>Timeout Error</strong> - 2 minutes ago
							</p>
