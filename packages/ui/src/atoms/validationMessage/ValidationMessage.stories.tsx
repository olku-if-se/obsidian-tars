...
export const LongMessage: Story = {
	args: {
		message: 'The JSON configuration is invalid. Please check for missing commas, unclosed brackets, or other syntax errors. You can use a JSON validator to ensure the format is correct.',
		type: 'error',
	},
}
