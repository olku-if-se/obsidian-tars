import { Input, Toggle, SettingRow } from '../../atoms'
...
export const ClaudeConfigPanel = ({ options, onChange, disabled = false }: ClaudeConfigPanelProps) => {
	...
	return (
		<div className={styles.claudeConfigPanel}>
			...
			<SettingRow
				name="Budget tokens for thinking"
				description="Must be ≥1024 and less than max_tokens"
			>
				<div className={styles.inputContainer}>
					<Input
						...
						className={`${styles.tokenInput} ${
							budgetTokensError ? styles.error : ''
						}`}
					/>
			...
			<SettingRow
				name="Max tokens"
				description="Refer to the technical documentation"
			>
				<div className={styles.inputContainer}>
					<Input
