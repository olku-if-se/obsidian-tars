  ...
  return (
    ...
    >
      ...
      <Section title={strings.globalSettings}>
        ...
        <SettingRow
          name={strings.concurrentExecutions}
          description={strings.concurrentExecutionsDesc}
        >
          <Input
            type="number"
            value={globalLimits.concurrentExecutions.toString()}
            onChange={(e) => onUpdateGlobalLimits({
              concurrentExecutions: parseInt(e.target.value) || 1
            })}
            min="1"
            max="20"
          />
        ...
        <SettingRow
          name={strings.sessionLimit}
          description={strings.sessionLimitDesc}
        >
          <Input
            type="number"
            value={globalLimits.sessionLimitPerDocument.toString()}
            onChange={(e) => onUpdateGlobalLimits({
              sessionLimitPerDocument: parseInt(e.target.value) || 1
            })}
            min="1"
            max="200"
          />
        ...
        <SettingRow
          name={strings.defaultTimeout}
          description={strings.defaultTimeoutDesc}
        >
          <Input
            type="number"
            value={globalLimits.defaultTimeout.toString()}
            onChange={(e) => onUpdateGlobalLimits({
              defaultTimeout: parseInt(e.target.value) || 10
            })}
            min="5"
            max="300"
          />
