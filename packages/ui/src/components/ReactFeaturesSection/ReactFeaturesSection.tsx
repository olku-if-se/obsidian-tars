    ...
    >
      ...
      <Section title="Feature Toggles">
        <SettingRow
          ...
          description={strings.settingsTabDesc}
        >
          <Toggle
        ...
        <SettingRow
          name={strings.statusBar}
          description={strings.statusBarDesc}
        >
          <Toggle
        ...
        <SettingRow
          name={strings.modals}
          description={strings.modalsDesc}
        >
          <Toggle
        ...
        <SettingRow
          name={strings.mcpUI}
          description={strings.mcpUIDesc}
        >
          <Toggle
            checked={features.reactMcpUI}
            onChange={(e) => handleFeatureToggle('reactMcpUI', e.target.checked)}
          />
        </SettingRow>
      </Section>
