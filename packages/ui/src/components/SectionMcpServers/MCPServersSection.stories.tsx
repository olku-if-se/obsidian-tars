...
const managedServerBase: Pick<
	MCPServerConfig,
	'configInput' | 'displayMode' | 'validationState' | 'failureCount' | 'autoDisabled' | 'retryPolicy' | 'timeout'
> = {
...
const externalServerBase: Pick<
	MCPServerConfig,
	'configInput' | 'displayMode' | 'validationState' | 'failureCount' | 'autoDisabled' | 'timeout'
> = {
