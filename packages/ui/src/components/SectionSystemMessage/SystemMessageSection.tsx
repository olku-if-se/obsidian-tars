...
export const SystemMessageSection = ({
	...
	return (
		<CollapsibleSection {...collapsibleSectionProps}>
			<SettingRow name={strings.enableDefaultSystemMsg} description={strings.enableDefaultSystemMsgDescription}>
				<Toggle {...toggleProps} />
			</SettingRow>

			<SettingRow name={strings.defaultSystemMsg} vertical={true}>
