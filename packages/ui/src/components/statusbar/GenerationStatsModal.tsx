...
// Re-use types from MCPStatusModal
import type { ErrorLogEntry, ErrorInfo } from './MCPStatusModal'
import { formatDuration } from './utilities'
import { LabelValueList } from './atoms'
...
export const GenerationStatsModal: React.FC<GenerationStatsModalProps> = ({
	stats,
	errorLog = [],
	onClose
}) => {
