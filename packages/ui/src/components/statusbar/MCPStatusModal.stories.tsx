...
import type { MCPStatusInfo, ErrorLogEntry, ErrorInfo } from './MCPStatusModal'

const meta: Meta<typeof MCPStatusModal> = {
	title: 'Components/Status/MCPStatusModal',
