...
const meta = {
	...
	parameters: {
		...
		docs: {
			description: {
				component: 'Atomic element for listing textual content. The smallest text unit for descriptions, summaries, and documentation.'
			}
		}
	},
	tags: ['autodocs'],
...
export const LongContent: Story = {
	args: {
		items: [
			{
				content: 'This is a very long paragraph that demonstrates how the component handles extended text content. It contains multiple sentences and shows how text wraps within the paragraph container. This is useful for testing how the component behaves with lengthy descriptions or detailed information that needs to be displayed to the user.'
			},
			{
				content: 'Here is another lengthy paragraph that continues the test of handling substantial text content. This allows us to verify that the styling remains consistent and that the layout properly accommodates paragraphs with varying amounts of text content.'
			}
		],
...
export const Documentation: Story = {
	args: {
		items: [
			...
			{ content: 'This interface displays real-time information about Model Context Protocol (MCP) servers running in your environment.' },
