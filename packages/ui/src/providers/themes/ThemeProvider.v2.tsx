...
import { type Theme, type ThemeName, useTheme } from '../../hooks/useTheme.v2'
...
export function useThemeContext(): ThemeContextValue {
	...
	if (!context) {
		throw new Error('useThemeContextV2 must be used within a ThemeProviderV2')
	}
	return context
}
...
export function useThemeColorV2(colorVar: string): string {
