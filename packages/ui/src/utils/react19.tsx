...
export function createPolymorphicComponent<P extends { as?: React.ElementType }, E extends React.ElementType = 'div'>(
	defaultElement: E
) {
	return forwardRef<any, P & ComponentProps<E>>(({ as: Component = defaultElement, ...props }, ref) => {
		return <Component ref={ref} {...props} />
	})
}

// React 19 startTransition utility wrapper
export function withStartTransition<T extends any[], R>(fn: (...args: T) => R | Promise<R>) {
...
export function createDeferredUpdater<T>(setter: React.Dispatch<React.SetStateAction<T>>) {
