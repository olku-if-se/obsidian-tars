...
import type { ErrorLogEntry, GenerationStats } from './GenerationStatsModal'
import { GenerationStatsModal } from './GenerationStatsModal'

const meta: Meta<typeof GenerationStatsModal> = {
	title: 'Views/GenerationStatsModal',
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					'Modal for displaying AI generation statistics including round, model, duration, and character count.'
			}
		}
	},
	tags: ['autodocs'],
